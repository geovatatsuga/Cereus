  ...
  return (
    <div className="p-4 sm:p-8 pb-20 max-w-7xl mx-auto w-full space-y-8 relative z-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <section className="bg-white rounded-[1.5rem] border border-slate-100 shadow-sm overflow-hidden">
          <div className="p-4 border-b border-slate-100 flex items-center justify-between">
            <h3 className="font-black text-slate-900">Fila priorizada</h3>
            <span className="bg-rose-50 text-rose-700 px-2.5 py-1 rounded-lg text-xs font-black">6 pendencias</span>
          </div>
        ...
        <section className="lg:col-span-2 bg-white rounded-[1.5rem] border border-slate-100 shadow-sm overflow-hidden">
          <div className="p-5 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-3">
            ...
            <span className={`w-fit px-3 py-1.5 rounded-xl text-xs font-black ${
          ...
          <div className="p-4 border-t border-slate-100 bg-white">
            ...
            <div className="relative">
              <input className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3.5 pl-4 pr-12 text-sm outline-none focus:ring-2 focus:ring-teal-500/30" placeholder="Responder cliente..." />
